...
<script src="@ckeditor/ckeditor5-easy-image"></script>
...
<body>
	...
	<%
		...
		//System.out.println("after resulset declarations user id..." + session.getAttribute("userId"));
	%>
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item" id="ans"><a class="nav-link"
					href="answer1.jsp" id="answerId"><i
			...
			<div class="col-sm-8 text-left" id="includedContent">
				...
				<%
					...
					while (resultSetAllQuestion.next()) {
						...
						//System.out.println("inside while before if statement for date...");
