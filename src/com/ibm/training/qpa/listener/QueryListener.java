...
/**
 * Application Lifecycle Listener implementation class QueryListener
 *
 */
@WebListener
public class QueryListener implements ServletContextListener, ServletContextAttributeListener, ServletRequestListener, ServletRequestAttributeListener, HttpSessionListener, HttpSessionAttributeListener, HttpSessionActivationListener, HttpSessionBindingListener, HttpSessionIdListener, AsyncListener {
     ...
     */
    public void contextInitialized(ServletContextEvent serve)  { 
    	try {
